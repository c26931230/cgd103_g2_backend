...
VALUES
(1,'2022-08-04 00:00:00',101,102,17600,3520,14080,'新竹市五福路16號','魏嘉佑','0982777649');
...
INSERT INTO order_item(order_id,product_id,quantity,item_price,size,color)
VALUES
(101,101,4,500,'M','#008000'),
(101,102,2,600,'S','#0000FF'),
(101,103,12,1200,'L','#FF0000');
...
INSERT INTO product (product_name, hashtag, unit_price, product_state, product_maintype, product_type, product_pic, style_type, body_type, product_gender, product_color,product_color_name, product_size,product_text) VALUES
 ('襯衫', '極簡風,素色,倒三角型', 500, 1, '上身', '長袖', 'F1_01_1.jpg,F1_01_2.jpg', '極簡風', '倒三角型', 1,'#FFFFFF,#0000FF', 'white,blue','XS,S,M,L,XL',null ),
 ('長褲', '極簡風,矩形', 600, 1, '下身', '長褲', 'F1_02_1.jpg', '極簡風', '矩形', 1, '#000000','black' ,'XS,S,M,L,XL',null ),
 ('皮鞋', '極簡風,皮革,蘋果型', 1200, 1, '鞋款', '皮鞋', 'F1_03_1.jpg', '極簡風', '蘋果型', 1, '#000000','black','25,26,27,28,29,30,31',null),
 ( '前口袋連帽外套', '文青風,梨型', 900, 1, '上身', '外套', 'F2_01_1.jpg', '文青風', '梨型', 1, '#003366','blue' ,'XS,S,M,L,XL',null ),
 ('毛帽', '文青風,休閒風,針織', 300, 1, '配件', '配件', 'F2_02_1.jpg', '文青風,休閒風', null, 1, '#CC5500','orange', 'F',null),
 ( '大口袋長褲', '文青風,倒三角型', 550, 1, '下身', '長褲', 'F2_03_1.jpg,F2_03_2.jpg', '文青風,休閒風,運動風', '沙漏型', 1, '#000000,#FFFFFF','black,white' ,'XS,S,M,L,XL',null ),
 ( '皮製外套', '時尚風,皮革,矩形', 1300, 1, '上身', '外套', 'F3_01_1.jpg', '時尚風', '矩形', 1, '#000000','black' ,'XS,S,M,L,XL',null ),
 ('連帽外套', '時尚風,蘋果型', 600, 1, '上身', '外套', 'F3_02_1.jpg', '時尚風,休閒風,運動風', '蘋果型', 1, '#FFFFFF','white' ,'XS,S,M,L,XL',null ),
 ( '牛仔褲', '時尚風,單寧,梨型', 700, 1, '下身', '長褲', 'F3_03_1.jpg', '時尚風,休閒風', '梨型', 1, '#0000FF','blue' ,'XS,S,M,L,XL',null ),
 ( '運動鞋', '時尚風,運動風', 900, 1, '鞋款', '運動鞋', 'F3_04_1.jpg,F3_04_2.jpg', '時尚風,運動風', null, 1, '#FFFFFF','white','25,26,27,28,29,30,31',null),
 ( '運動鞋', '運動風', 900, 1, '鞋款', '運動鞋', 'F4_02_1.jpg,F4_02_2.jpg', '運動風', null, 1, '#808080','gray', '25,26,27,28,29,30,31',null),
 ('針織上衣', '文青風,針織,倒三角型', 900,1, '上身', '長袖', 'W1_01_1.jpg', '文青風', '倒三角型', 0, '#808080','gray' ,'XS,S,M,L,XL',null ),
 ( '襯衫', '文青風,矩形', 900, 1, '上身', '長袖', 'W1_02_1.jpg', '文青風', '矩形', 0, '#0000FF','blue' ,'XS,S,M,L,XL',null ),
 ( '黑裙', '文青風,蘋果型', 900, 1, '下身', '裙子', 'W1_03_1.jpg', '文青風', '蘋果型',0 ,'#000000','black' ,'XS,S,M,L,XL',null ),
 ('小白鞋', '文青風,極簡風', 900, 1, '鞋款', '運動鞋', 'W1_04_1.jpg', '文青風,極簡風', null, '0', '#FFFFFF','white', '22,23,24,25,26',null),
 ( '洋裝', '時尚風,梨型', 1200, 1, '下身', '裙子', 'W2_01_1.jpg', '時尚風', '梨型', 0, '#FFFFFF','white' ,'XS,S,M,L,XL',null ),
 ( '低跟鞋', '時尚風', 1800, 1, '鞋款', '跟鞋', 'W2_02_1.jpg,W2_02_2.jpg', '時尚風', null, 0, '#C0C0C0','blue' ,'22,23,24,25,26',null),
 ( '運動外套', '運動風,矩形', 900,1, '上身', '外套', 'W3_01_1.jpg', '運動風', '矩形', 0, '#E32636','red' ,'XS,S,M,L,XL',null ),
 ( '豹紋長褲', '運動風,倒三角型', 900, 1, '下身', '長褲', 'W3_03_1.jpg', '運動風', '沙漏型', 0, '#4D1F00','brown' ,'XS,S,M,L,XL',null ),
 ( '黑鞋', '運動風,休閒風', 1200, 1, '鞋款', '皮鞋', 'W3_02_1.jpg', '時尚風,休閒風', null, 0, '#000000','black' ,'22,23,24,25,26',null),
 ('襯衫', '極簡風,素色,蘋果型', 900, 1, '上身', '長袖', 'W4_01_1.jpg', '極簡風', '蘋果型', 0, '#FFFFFF','white' ,'XS,S,M,L,XL',null ),
 ('長褲', '極簡風,梨型', 900, 1, '下身', '長褲', 'W4_02_1.jpg', '極簡風', '梨型', 0, '#000000','black' ,'XS,S,M,L,XL',null ),
...
INSERT INTO  product_combo (combo_name,combo_main_pic, combo_pic, hashtag, emp_id, body_type, style_type, combo_price) VALUES
  ...
  ('學院文青穿搭','look-1.jpg','look-1.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '文青風,沙漏型,日系', 101, '矩型', '文青風', 4970),
  ('居家運動穿搭','look-2.jpg','look-2.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '運動風,矩型,舒適', 102, '蘋果型', '運動風', 4670),
  ('極簡混搭穿搭','look-3.jpg','look-3.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '極簡風,梨型,混搭', 103, '沙漏型', '極簡風', 8970),
  ('日系文青穿搭','look-4.jpg','look-4.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '文青風,梨型,日系', 104, '梨型', '文青風', 6960),
  ('簡約時尚穿搭','look-5.jpg','look-5.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '時尚風,沙漏型,簡約', 105, '沙漏型', '時尚風', 9370),
  ('舒適運動穿搭','look-6.jpg','look-6.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '運動風,頻果型,美式', 101, '蘋果型', '運動風', 4670),
  ('時尚OL穿搭','look-7.jpg','look-7.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '時尚風,沙漏型,都會OL', 102, '沙漏型', '時尚風', 5570),
  ('時尚機能混搭穿搭','look-8.jpg','look-8.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '時尚風,沙漏型,混搭機能', 103, '沙漏型', '時尚風', 6370),
  ('簡約舒適穿搭','look-9.jpg','look-9.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '極簡風,矩型,簡約', 104, '矩型', '極簡風', 2980),
  ('時尚韓系穿搭','look-10.jpg','look-10.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '時尚風,沙漏型,韓系', 105, '沙漏型', '時尚風', 5760),
	('都會簡約時尚穿搭','look-11.jpg','look-11.jpg,look-info-pic2.png,look-info-pic3.png,look-info-pic4.png,look-info-pic5.png', '極簡風,沙漏型,時尚', 101, '沙漏型', '極簡風', 12860);
...
VALUES
(101,'2022-08-05 16:24:00',1,'想詢問如何退貨？',101,null),
(101,'2022-08-06 16:30:00',0,'只要14天以內都可以退貨唷，或者也可以參考我們的FAQ說明',101,102);
...
INSERT INTO vip_orders (order_id,mem_id,level_id,sub_time,sub_deadline,sub_paid,sub_status)
VALUES
(NULL,101,101,'2022-07-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),899,1),
(NULL,102,102,'2022-07-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),1599,1),
(NULL,103,103,'2022-08-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),3999,1),
(NULL,105,102,'2022-08-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),1599,1),
(NULL,107,101,'2022-09-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),899,1),
(NULL,108,102,'2022-09-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),1599,1),
(NULL,110,102,'2022-10-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),1599,1),
(NULL,112,101,'2022-11-25 12:07:43',TIMESTAMPADD(MONTH,1,sub_time),899,1),
(NULL,115,101,CURRENT_TIMESTAMP(),TIMESTAMPADD(MONTH,1,sub_time),899,1),
(NULL,116,102,CURRENT_TIMESTAMP(),TIMESTAMPADD(MONTH,1,sub_time),1599,1),
(NULL,117,103,CURRENT_TIMESTAMP(),TIMESTAMPADD(MONTH,1,sub_time),3999,1);
