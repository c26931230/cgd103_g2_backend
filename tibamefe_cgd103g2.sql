...
INSERT INTO product (product_name, hashtag, unit_price, product_state, product_maintype, product_type, product_pic, style_type, body_type, product_gender, product_color,product_color_name, product_size) VALUES
	...
	('合身剪裁長版大衣', '極簡風,素色,蘋果型', 5590, 1, '上身', '長袖', '/product/look-item-1.png', '極簡風', '蘋果型', 0, '#FFFFFF','brown' ,'XS,S,M,L,XL','一件剪裁考究的外套，可以根據您的著裝和溫度，將衣領向上或向下穿著' ),
	('簡約條紋襯衫', '極簡風,素色,蘋果型', 1990, 1, '上身', '長袖', '/product/look-item-2.png', '極簡風', '蘋果型', 0, '#FFFFFF','beige' ,'XS,S,M,L,XL','舒適的棉質襯衫。設計點是清新的條紋圖案' ),
	('平紋針織高喬褲', '極簡風,素色,蘋果型', 1290, 1, '上身', '長袖', '/product/look-item-3.png', '極簡風', '蘋果型', 0, '#FFFFFF','beige' ,'XS,S,M,L,XL','通過排列環，您可以享受直線和曲線的輪廓' ),
	('時尚短靴', '極簡風,素色,蘋果型', 3990, 1, '上身', '長袖', '/product/look-item-4.png', '極簡風', '蘋果型', 0, '#FFFFFF','black' ,'XS,S,M,L,XL','從材料到細節，我們都非常注重細節，以實現舒適性和高設計性' );
