      ...
      <div id="edit_box">
        ...
        <div class="wrap" id="wrap">
          <div class="sub_form_item">
            <div class="option">
              <input type="file" />
              <input type="text" placeholder="單品編號1">
              <button class="remove_sub_item">
                刪除
              </button>
            </div>
          </div>
          <div class="sub_form_item">
            <div class="option">
              <input type="file" />
              <input type="text" placeholder="單品編號2">
              <button class="remove_sub_item">
                刪除
              </button>
            </div>
        ...
        <div class="confirm_box">
          ...
          <table class="table shop_table">
            ...
            <tbody>
              <tr v-for="item in product" class="item" :key="item.id"  @click="open()">
                <!-- 編號 -->
